  ...
  <div class="app-container">
    <el-card>
      <el-form :model="queryParams" ref="queryRef" label-width="80px" class="filter-form">
        <el-form-item class="filter-item filter-item-full" :label="tr('出库状态')" prop="orderStatus">
        ...
        <el-form-item class="filter-item filter-item-full" :label="tr('出库类型')" prop="optType">
        ...
        <el-form-item class="filter-item" :label="tr('出库单号')" prop="orderNo">
          <el-input
    ...
    <el-card class="mt20">
      ...
      >
        ...
        <el-table-column :label="tr('出库状态')" align="center" prop="orderStatus" width="80">
          <template #default="{ row }">
            <dict-tag :options="translatedShipmentStatusOptions" :value="row.orderStatus" />
          </template>
        </el-table-column>
        <el-table-column :label="tr('出库类型')" align="center" prop="optType" width="100">
          <template #default="{ row }">
            <dict-tag :options="translatedShipmentTypeOptions" :value="row.optType" />
          </template>
        </el-table-column>
        <el-table-column :label="tr('客户')" align="left" prop="merchantId">
          <template #default="{ row }">
