  ...
  <div class="app-container">
    <el-card>
      <el-form :model="queryParams" ref="queryRef" label-width="80px" class="filter-form">
        <el-form-item class="filter-item filter-item-full" label="出库状态" prop="orderStatus">
        ...
        <el-form-item class="filter-item filter-item-full" label="出库类型" prop="optType">
        ...
        <el-form-item class="filter-item" label="出库单号" prop="orderNo">
          <el-input
